...
from src.model import CustomSEResNeXt, CustomSEResNeXtMrk2, CustomSEResNeXtV2, GeM, Mish, CustomSEResNeXtMrk3, CustomSEResNeXtV3
...
class PANDADataset:
    ...
    def __getitem__(self, item):
        ...
        if os.path.isfile(config.TRAIN_PROCESSED_IMG_PATH+f'{file_name}_1.jpeg'):
            file_path = config.TRAIN_PROCESSED_IMG_PATH + f'{file_name}_1.jpeg'
        else:
            file_path = config.TRAIN_IMG_PATH + f'{file_name}_1.jpeg'  
...
if __name__ == '__main__':
    ...
    LOGGER.info(f'{EXP_ID} : exp4 (LB 0.85) + apply cleaned with mask')    
