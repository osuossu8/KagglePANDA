...
EXP_ID = 'exp5'
import configs.config5 as config
import src.engine5 as engine
...
tile_mode = 0
tile_size = 144 # 128 # 256
image_size = 144 # 128 # 256
n_tiles = 36
...
def run_one_fold(fold_id):
    ...
    model = Efficient(1, encoder='efficientnet-b0', pool_type="gem")
