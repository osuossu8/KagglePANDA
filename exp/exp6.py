...
from src.model import CustomSEResNeXtV2 as CustomSEResNeXt
...
def run_one_fold(fold_id):
    ...
    model = CustomSEResNeXt(model_name='se_resnext50_32x4d', num_classes=1, n_tiles=36)
...
if __name__ == '__main__':
    ...
    LOGGER.info(f'{EXP_ID} : exp2 (LB 0.85) + apply AttentionPoolHead')
